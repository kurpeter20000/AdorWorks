...
export const DOMAIN_EVENTS = {
  ...
  ACCOUNT_SESSIONS_REVOKED: "identity.account.sessions_revoked",
  ROLE_CONTEXT_SWITCHED: "identity.role_context.switched",
  TEAM_MEMBER_INVITED: "organisation.team_member.invited",
  TEAM_MEMBER_ROLE_CHANGED: "organisation.team_member.role_changed",
  TEAM_MEMBER_REMOVED: "organisation.team_member.removed",
